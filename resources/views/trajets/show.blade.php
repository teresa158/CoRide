                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-bold">
                                @if($trajet->conducteur)
                                    <a href="{{ route('dashboard', $trajet->conducteur) }}" class="text-emerald-400 hover:underline font-bold">
                                ...
                                <div>
                                    <span class="font-semibold text-white">
                                        @if($reservation->passager)
                                            <a href="{{ route('dashboard', $reservation->passager) }}" class="hover:text-emerald-400 hover:underline transition font-bold">
